...
export class ApiInscriptionAdminService {
  ...
  getAll(): Observable<InscriptionDto[]>{
    return this.http.get<InscriptionDto[]>(UTAIDA_PROJECT.back.url + "/inscriptions")
  }

  getInscriptionsByWorkshop(workshopSlug : WorkshopDto['slug']): Observable<InscriptionDto[]>{
    return this.http.get<InscriptionDto[]>(UTAIDA_PROJECT.back.url + "/inscriptions/workshop/" + workshopSlug)
  }
