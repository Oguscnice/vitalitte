...
export class ApiWorkshopAdminService {
  ...
  getAllWorkshops(): Observable<WorkshopDto[]> {
    return this.http.get<WorkshopDto[]>(VITALITTE_PROJECT.back.url + "/workshops")
  }

  post(workshop : CreateWorkshop): Observable<ResponseEntity>{
    return this.http.post<ResponseEntity>(VITALITTE_PROJECT.back.url + "/workshops", workshop)
  }

  put(workshop : WorkshopDto): Observable<ResponseEntity>{
    return this.http.put<ResponseEntity>(VITALITTE_PROJECT.back.url + "/workshops/" + workshop.slug, workshop)
  }

  changeAvailability(workshop : WorkshopDto): Observable<ResponseEntity>{
    return this.http.put<ResponseEntity>(VITALITTE_PROJECT.back.url + "/workshops/availability", workshop)
  }

  delete(workshopSlug : WorkshopDto['slug']): Observable<ResponseEntity>{
    return this.http.delete<ResponseEntity>(VITALITTE_PROJECT.back.url + "/workshops/" + workshopSlug)
  }
