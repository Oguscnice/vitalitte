...
export const NOTEBOOKS: Notebook[] = [
  ...
  },
  {
    ...
    descriptions : [
      ...
      `Des illustrations botaniques exquises et des motifs inspirés par la flore mondiale parsèment les pages, créant une expérience immersive au cœur du règne végétal. Des nuances de vert apaisantes et des touches de couleur inspirées des plantes ajoutent une dimension artistique, faisant de chaque page un jardin miniature.`,
  ...
  },
  {
    ...
    descriptions : [
      ...
      `Des illustrations captivantes de flammes tourbillonnantes et de braises incandescentes animent les pages, évoquant la vitalité et la force du feu. Des teintes de rouge, d'or et de noir créent un contraste saisissant, tandis que des détails subtils rappellent la ferveur de l'élément feu.`,
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Des illustrations délicates d'animaux marins et des citations inspirantes bordent les pages, créant une atmosphère empreinte de calme et de contemplation. Ce carnet est plus qu'un simple objet, c'est une invitation à plonger dans les profondeurs de votre imagination.`,
      `Chaque carnet artisanal bio "Le Trésor de l'Océan" incarne l'engagement envers la préservation des océans et rappelle la beauté fragile de notre écosystème marin. En choisissant ce carnet, vous soutenez la protection des mers et des créatures qui les habitent.`
    ],
    components : [
      'Papier recyclé et durable',
      'reliure japonaise',
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Des illustrations de fées, d'oiseaux chanteurs et de fleurs fantastiques parsèment le carnet, créant une atmosphère poétique. Les citations inspirantes vous guident dans ce voyage enchanteur, où chaque idée peut prendre racine et s'épanouir comme une fleur magique.`,
      `Choisir le carnet "Le Jardin Enchanté", c'est inviter la magie dans votre quotidien tout en affirmant votre engagement envers des pratiques respectueuses de la nature. Ce carnet est une passerelle vers un monde où la créativité et la nature fusionnent harmonieusement.`
    ],
    components : [
      'Papier recyclé et durable',
      'papier mâché',
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Inspiré par la magie de l'espace infini, ce carnet incite à la réflexion profonde et à l'exploration créative. Choisir ce carnet, c'est embrasser l'inconnu avec chaque ligne tracée.`,
    ],
    components: [
      'Papier recyclé et durable',
      'papier mâché',
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Des illustrations évoquant différentes époques et des citations philosophiques jalonnent les pages, créant une expérience d'écriture qui transcende le présent. Choisir ce carnet, c'est entreprendre un voyage intemporel à chaque ligne.`,
    ],
    components: [
      'Cuir vieilli',
      'cuir végétalien',
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Des illustrations évoquant des créatures mystiques et des citations inspirantes de la nature parsèment les pages, créant une atmosphère de calme et de rêverie. Choisir ce carnet, c'est s'immerger dans un monde où la magie de la forêt se mêle à l'expression artistique.`,
    ],
    components: [
      'Cuir végétalien',
      'papier recyclé et durable',
